import mascotDrinking from '@/assets/mascot/mascot-drinking.png'

export function RewardsProfile({ status }: { status: React.ReactNode }) {
  return (
    <header className="relative min-h-44 lg:sticky lg:top-12 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:flex lg:min-h-[560px] lg:items-start lg:rounded-[28px] lg:border lg:border-border/80 lg:bg-card/50 lg:p-[30px] lg:shadow-[0_24px_70px_rgba(120,72,44,0.1)] lg:backdrop-blur-md">
      <div>
        <p className="mb-7 mt-0 font-mono text-xs tracking-[0.14em] text-muted-foreground lg:mb-11">REWARDS</p>
        <p className="m-0 text-sm text-muted-foreground">Mga handa at progreso</p>
